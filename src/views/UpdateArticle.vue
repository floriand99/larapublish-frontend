<template>
    ...
    >
        <div class="mx-auto lg:w-8/12 space-y-8 my-10">
            ...
            <div>
                <div v-if="image">
                <img :src="'https://calm-forest-02990.herokuapp.com/' + image" class="my-6 w-full object-cover" />
            ...
            <div>
                ...
                ></vue-editor>
                <div class="text-gray-500 text-xs flex items-center mt-1">
                        <span class="mr-1">Enter between 100 and 3000 characters. Character count: {{contentCharCount}}</span>
...
<script>
import {ArticleService, ImageService} from '@/services/api.service'
...
export default {
    ...
    async created(){
        ...
        this.tags = res.data.tags.map(item => item.content)
        this.image = res.data.image
    },
    methods:{
        async deleteImage(){
            await ImageService.delete(this.image)
            this.image = null
        },
    }
};
